...
class preimgpdf:
    ...
    def set_dir(self,invoice_path,i):
        ...
        company_dir = os.path.join('runs','detect','exp'+app,'crops','COMPANY', invoice_name)
        invoice_date_dir = os.path.join('runs','detect','exp'+app,'crops','INVOICE DATE' , invoice_name)
        table_dir = os.path.join('runs','detect','exp'+app,'crops','TABLE', invoice_name)
        total_dir = os.path.join('runs','detect','exp'+app,'crops','TOTAL' , invoice_name)
        gst_dir = os.path.join('runs','detect','exp'+app,'crops','GST' , invoice_name)
        abn_dir = os.path.join('runs','detect','exp'+app,'crops','ABN' , invoice_name)
        account_dir = os.path.join('runs','detect','exp'+app,'crops','ACCOUNT_DETAILS' , invoice_name)
